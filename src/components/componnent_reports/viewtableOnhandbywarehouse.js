...
const ViewtableOnhandbywarehouse = (props) => {
    const { data } = props
    ...
    const LoadingExcel=()=>{
        return(
        <ExcelFile element={<button>Download Data</button>} filename={"Onhand by Warehouse"+d.getDate()+"-"+d.getMonth()+"-"+d.getFullYear()}>
...
export default ViewtableOnhandbywarehouse;
